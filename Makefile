...
%.bc: %.c
	$(CC) $(CFLAGS) $(DEFINES) -o $@ -I/home/rubio/anaconda3/envs/numbaEnv/include/python3.12 $<
...
$(EXECUTABLE_UNOPT): $(BC_FILES)
	$(CC) -g $(BC_FILES) -lm -lpython3.12 -lonig -o $@ $(DEFINES) -L/usr/local/lib -lonig -L/home/rubio/anaconda3/envs/numbaEnv/lib/python3.12/config-3.12-x86_64-linux-gnu -I/home/rubio/anaconda3/envs/numbaEnv/include/python3.12
