...
UNOPT_BC = runjq.bc
OPT_BC = runjq_inlined.bc

# Executable
EXECUTABLE_UNOPT = runjq
EXECUTABLE_OPT = runjq_opt
...
$(OPT_BC): $(UNOPT_BC)
	$(OPT) -passes='default<O1>,inline' $< -o $@
