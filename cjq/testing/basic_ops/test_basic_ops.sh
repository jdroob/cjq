...
for jq_file in cjq/testing/basic_ops/jq/prod_example/*.jq; do
    ...
    clang cjq/bootstrap/*.c cjq/trace/cjq_trace.c cjq/jq/src/*.c cjq/llvmlib/*.c cjq/pylib/*.c cjq/jq/src/decNumber/decNumber.c cjq/jq/src/decNumber/decContext.c ir.ll -g -lm -o runjq -lpython3.12 -DUSE_DECNUM=1 -Wno-deprecated-non-prototype
